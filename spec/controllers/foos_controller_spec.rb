  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested foo" do
        ...
        Foo.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => foo.to_param, :foo => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the foo as @foo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Foo.any_instance.stub(:save).and_return(false)
        put :update, {:id => foo.to_param, :foo => {  }}, valid_session
        assigns(:foo).should eq(foo)
      end
